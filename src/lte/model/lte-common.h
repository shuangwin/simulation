...
//JMS add to trace the packets sent from enb mac to phy
...
struct PacketsFromMacToPhy
{
   ...
   *  TracedCallback signature.
   *
   * \param [in] params Value of the PacketsFromMacToPhy.
   */
  typedef void (* TracedCallback)(const PacketsFromMacToPhy params);
